...
app.get("/login", function (req, res) {
  console.log(`app.get("/login", function (req, res)`); // DEBUG
...
app.get("/callback", function (req, res) {
  console.log(`app.get("/callback", function (req, res)`); // DEBUG
  ...
  console.log("storedState:", storedState); // DEBUG
...
app.get("/refresh_token", function (req, res) {
  console.log(`app.get("/refresh_token", function (req, res)`); // DEBUG
